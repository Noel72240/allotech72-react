...
/**
 * Fond hexagonale sauvegardé (validé par le client).
 * Actuellement inactif — le fond actif est Background.jsx (orbites).
 * Pour le remettre : dans App.jsx et PageLayout.jsx,
 *   import Background from './BackgroundHex.jsx'
 */
